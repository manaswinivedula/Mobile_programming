                ...
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(result != null && result.size() > 0) {
                        ...
                        if(result.get(0).equalsIgnoreCase("hello") || result.get(0).equalsIgnoreCase("hi") || result.get(0).equalsIgnoreCase("hey")) {
                            ...
                            tts.speak("Oh, you have fever. Please take paracetamol.",
                                    TextToSpeech.QUEUE_FLUSH, null);
                            mVoiceInputTv.append(Html.fromHtml("<p style=\"color:red;\">Speaker : Oh, you have fever. Please take paracetamol.</p>"));
